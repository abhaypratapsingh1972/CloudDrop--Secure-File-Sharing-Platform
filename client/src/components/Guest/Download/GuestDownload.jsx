...
const GuestDownload = () => {
  ...
  const fetchFile = async () => {
    try {
      const res = await fetch(`https://clouddrop-api.onrender.com/api/files/g/${shortCode}`, {
  ...
  const verifyFile = async () => {
    ...
    try {
      const res = await fetch(`https://clouddrop-api.onrender.com/api/files/verifyGuestFilePassword`, {
        method: "POST",

...
const DownloadPage = () => {
  ...
  const fetchFile = async () => {
    try {
      const res = await fetch(`https://clouddrop-api.onrender.com/api/files/f/${shortCode}`, {
  ...
  const verifyFile = async () => {
    ...
    try {
      const res = await fetch(`https://clouddrop-api.onrender.com/api/files/verifyFilePassword`, {
        method: "POST",
